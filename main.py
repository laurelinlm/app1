...
template = """
 You are a marketing copywriter with 20 years of experience. You are analyzing customer's background to write personalized product description that only this customer will receive; 
    ...
    USE CASE: write a story in 5 sentences, how and when to use it taking into account xyz{xyz} and age {agegroup}, write a story in first person, example "Use it after ..."; OUTPUT TEXT in Estonian; 
"""
